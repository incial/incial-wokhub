...
const NavItem = ({ icon: Icon, label, to, active, collapsed }: { icon: any, label: string, to: string, active: boolean, collapsed: boolean }) => (
    <Link
        ...
        className={`relative group flex items-center ${collapsed ? 'justify-center px-2' : 'px-4 mx-3'} py-3 mb-1 rounded-2xl text-sm font-medium transition-all duration-300 ease-out ${active
...
export const Sidebar: React.FC = () => {
    ...
    return (
        <aside
            className={`${isSidebarCollapsed ? 'w-[5.5rem]' : 'w-[19rem]'
